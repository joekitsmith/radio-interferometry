...
class CoordinateExtractor():
    ...
    def convertCoordinateStringToList(self, coord_str : str) -> List[List[str]]:
        """
    ...
    def correctCoordinateListDataType(self, coord_list: list) -> List[List[object]]:
        """
    ...
    def extractCoordinateListFromText(self, title : str, text : str) -> List[List[object]]:
        """
        ...
        return(self.correctCoordinateListDataType(coord_list))