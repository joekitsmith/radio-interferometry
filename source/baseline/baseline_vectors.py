...
from source.parser.coordinate_extractor import CoordinateExtractor
from source.parser.data_validator import DataValidator
from source.antennae.antenna_array import AntennaArray
...
if __name__ == '__main__':
    parser = FileReader()
    text = parser.extractText("source\input_coordinates.txt")
